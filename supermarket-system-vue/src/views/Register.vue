    ...
    <div style="width: 400px; margin: 100px auto">
      ...
      <el-form ref="form" :model="form" size="normal" :rules="rules">
        <el-form-item prop="userCode">
          <el-input prefix-icon="el-icon-user-solid" v-model="form.userCode"></el-input>
        </el-form-item>
        <el-form-item prop="userPassword">
          <el-input prefix-icon="el-icon-lock" v-model="form.userPassword" show-password></el-input>
        </el-form-item>
