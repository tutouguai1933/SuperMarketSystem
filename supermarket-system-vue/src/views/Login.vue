        ...
        <div style="width: 400px; margin: 100px auto">
          ...
          <el-form ref="form" :model="form" size="normal" :rules="rules">
            <el-form-item prop="username">
              <el-input prefix-icon="el-icon-user-solid" v-model="form.userCode" placeholder="请输入账号"></el-input>
            </el-form-item>
            ...
            <el-form-item>
              <div style="display: flex">
                <el-input prefix-icon="el-icon-key" v-model="inputValidCode" style="width: 50%;"
    ...
    login() {
      this.$refs['form'].validate((valid) => {
        if (valid) {
          ...
          if (this.inputValidCode.toLowerCase() !== this.validCode.toLowerCase()) {
          ...
          request.post("/login", this.form).then(res => {
            if (res.code === '0') {
              ...
              this.$router.push("/bill")  //登录成功之后进行页面的跳转，跳转到主页
